...
const oakCentrePrime: EditorialPageData = {
  ...
  sections: [
    ...
    { eyebrow: "The architectural vision", title: "Connected spaces for health, learning, family life and community.", paragraphs: ["The public-facing architectural plan includes an administration and welcome building, health centre, community hall, inclusive education and therapy spaces, children’s accommodation, recreation facilities and accessible movement across the site."], points: ["Health centre and therapy support", "Inclusive school, skills and learning spaces", "Community hall and family support", "Children’s accommodation and respite", "Recreation, adaptive sport and wellbeing", "Quiet reflection and community gathering"] },
