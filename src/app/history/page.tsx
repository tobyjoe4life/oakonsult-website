...
export default function Page() {
  return <InteriorPage data={{
    ...
    items: [
      ...
      { title: "2022 - Inclusive church training", text: "The charity expanded disability-inclusion learning with churches and communities in Nigeria.", href: "/programmes/churches" },
