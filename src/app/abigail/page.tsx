...
import { abigailHero, abigailTributeGallery } from "@/lib/abigail-tribute";
...
const tribute: EditorialPageData = {
  ...
  heroImage: abigailHero.src,
  heroAlt: abigailHero.alt,
  heroPosition: abigailHero.position,
