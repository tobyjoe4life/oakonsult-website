...
export default function Page() {
  return <InteriorPage data={{
    ...
    items: [
      { title: "Morning Zumba for parent carers", text: "Free Project ME wellbeing session on 3rd Mondays, 11:45am to 12:45pm in Chapel Hall, Bromley. Registration is required.", href: "/zumba-class" },
      { title: "Evening Zumba for parent carers", text: "Free Project ME wellbeing session on 3rd Thursdays, 7:30pm to 8:30pm in Verrall Hall, Bromley. Registration is required.", href: "/zumba-class" },
