...
export const publicFormDefinitions: Record<PublicFormDefinition["id"], PublicFormDefinition> = {
  ...
  "partnership-referral": {
    ...
    fields: [
      ...
      { name: "supportNeeded", label: "Support that may help", type: "checkbox", options: ["Parent-carer wellbeing", "Project ME", "Community connection", "Optional faith-sensitive support, if wanted", "Signposting", "Other"] },
  ...
  "project-me-interest": {
    ...
    fields: [
      ...
      { name: "trainingGoals", label: "What would you like to gain?", type: "checkbox", options: ["Wellbeing and resilience", "Confidence and identity", "Peer connection", "Navigating support", "Optional faith-sensitive encouragement"] },
